...
export function buildWhatsAppURL(packageName = '') {
  const message = packageName
    ? `Hello Tour Trips, I am interested in the ${packageName} package. Can you provide more details?`
    : `Hello Tour Trips, I would like to know more about your travel packages. Please share the details.`;
  return `https://wa.me/${AGENCY_PHONE}?text=${encodeURIComponent(message)}`;
}

export function openWhatsApp(packageName = '') {
  window.open(buildWhatsAppURL(packageName), '_blank', 'noopener');
}

export function getWhatsAppSVG() {
